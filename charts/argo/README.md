...
| https://raw.githubusercontent.com/roberc7/airnz-helm-charts/gh-pages | external-secrets | 1.1.0 |
...
| argo-cd.applicationSet.metrics.serviceMonitor.namespace | string | `"monitoring"` | Prometheus ServiceMonitor namespace |
...
| argo-cd.applicationSet.metrics.serviceMonitor.selector | object | `{"release":"prometheus-oper"}` | Prometheus ServiceMonitor selector |
| argo-cd.applicationSet.name | string | `"applicationset-controller"` | Application Set controller name string |
| argo-cd.applicationSet.nodeSelector | object | `{"role":"argocd"}` | [Node selector] |
...
| argo-cd.applicationSet.tolerations | list | `[{"effect":"NoSchedule","key":"dedicated","operator":"Equal","value":"argocd"}]` | [Tolerations] for use with node taints |
...
| argo-cd.controller.metrics.rules.namespace | string | `"monitoring"` |  |
| argo-cd.controller.metrics.rules.selector.prometheus | string | `"kube-prometheus"` |  |
...
| argo-cd.controller.metrics.serviceMonitor.namespace | string | `"monitoring"` | Prometheus ServiceMonitor namespace |
| argo-cd.controller.metrics.serviceMonitor.relabelings | list | `[]` | Prometheus [RelabelConfigs] to apply to samples before scraping |
| argo-cd.controller.metrics.serviceMonitor.selector | object | `{"release":"prometheus-oper"}` | Prometheus ServiceMonitor selector |
| argo-cd.controller.name | string | `"application-controller"` | Application controller name string |
| argo-cd.controller.nodeSelector | object | `{"role":"argocd"}` | [Node selector] |
...
| argo-cd.controller.tolerations | list | `[{"effect":"NoSchedule","key":"dedicated","operator":"Equal","value":"argocd"}]` | [Tolerations] for use with node taints |
...
| argo-cd.dex.metrics.serviceMonitor.selector.release | string | `"prometheus-oper"` |  |
| argo-cd.dex.name | string | `"dex-server"` | Dex name |
| argo-cd.dex.nodeSelector | object | `{"role":"argocd"}` | [Node selector] |
...
| argo-cd.dex.tolerations | list | `[{"effect":"NoSchedule","key":"dedicated","operator":"Equal","value":"argocd"}]` | [Tolerations] for use with node taints |
...
| argo-cd.redis-ha.nodeSelector | object | `{"role":"argocd"}` | [Node selector] |
...
| argo-cd.redis-ha.tolerations | list | `[{"effect":"NoSchedule","key":"dedicated","operator":"Equal","value":"argocd"}]` | [Tolerations] for use with node taints |
...
| argo-cd.redis.nodeSelector | object | `{"role":"argocd"}` | [Node selector] |
...
| argo-cd.redis.tolerations | list | `[{"effect":"NoSchedule","key":"dedicated","operator":"Equal","value":"argocd"}]` | [Tolerations] for use with node taints |
...
| argo-cd.repoServer.metrics.serviceMonitor.namespace | string | `"monitoring"` | Prometheus ServiceMonitor namespace |
| argo-cd.repoServer.metrics.serviceMonitor.relabelings | list | `[]` | Prometheus [RelabelConfigs] to apply to samples before scraping |
| argo-cd.repoServer.metrics.serviceMonitor.selector | object | `{"release":"prometheus-oper"}` | Prometheus ServiceMonitor selector |
| argo-cd.repoServer.name | string | `"repo-server"` | Repo server name |
| argo-cd.repoServer.nodeSelector | object | `{"role":"argocd"}` | [Node selector] |
...
| argo-cd.repoServer.tolerations | list | `[{"effect":"NoSchedule","key":"dedicated","operator":"Equal","value":"argocd"}]` | [Tolerations] for use with node taints |
...
| argo-cd.server.nodeSelector | object | `{"role":"argocd"}` | [Node selector] |
...
| argo-cd.server.tolerations | list | `[{"effect":"NoSchedule","key":"dedicated","operator":"Equal","value":"argocd"}]` | [Tolerations] for use with node taints |
...
| argo-events.eventbusController.nodeSelector | object | `{"role":"argocd"}` | [Node selector] |
...
| argo-events.eventbusController.tolerations | list | `[{"effect":"NoSchedule","key":"dedicated","operator":"Equal","value":"argocd"}]` | [Tolerations] for use with node taints |
...
| argo-events.eventsourceController.nodeSelector | object | `{"role":"argocd"}` | [Node selector] |
...
| argo-events.eventsourceController.tolerations | list | `[{"effect":"NoSchedule","key":"dedicated","operator":"Equal","value":"argocd"}]` | [Tolerations] for use with node taints |
...
| argo-events.sensorController.nodeSelector | object | `{"role":"argocd"}` | [Node selector] |
...
| argo-events.sensorController.tolerations | list | `[{"effect":"NoSchedule","key":"dedicated","operator":"Equal","value":"argocd"}]` | [Tolerations] for use with node taints |
...
| argo-rollouts.controller.metrics.serviceMonitor.namespace | string | `"monitoring"` |  |
| argo-rollouts.controller.metrics.serviceMonitor.selector.release | string | `"prometheus-oper"` |  |
| argo-rollouts.controller.nodeSelector.role | string | `"argocd"` |  |
...
| argo-rollouts.controller.tolerations[0].effect | string | `"NoSchedule"` |  |
| argo-rollouts.controller.tolerations[0].key | string | `"dedicated"` |  |
| argo-rollouts.controller.tolerations[0].operator | string | `"Equal"` |  |
| argo-rollouts.controller.tolerations[0].value | string | `"argocd"` |  |
...
| argo-rollouts.dashboard.nodeSelector.role | string | `"argocd"` |  |
...
| argo-rollouts.dashboard.tolerations[0].effect | string | `"NoSchedule"` |  |
| argo-rollouts.dashboard.tolerations[0].key | string | `"dedicated"` |  |
| argo-rollouts.dashboard.tolerations[0].operator | string | `"Equal"` |  |
| argo-rollouts.dashboard.tolerations[0].value | string | `"argocd"` |  |
...
| argo-workflows.controller.nodeSelector | object | `{"kubernetes.io/os":"linux","role":"argocd"}` | [Node selector] |
...
| argo-workflows.controller.tolerations | list | `[{"effect":"NoSchedule","key":"dedicated","operator":"Equal","value":"argocd"}]` | [Tolerations] for use with node taints |
...
| argo-workflows.server.nodeSelector | object | `{"kubernetes.io/os":"linux","role":"argocd"}` | [Node selector] |
...
| argo-workflows.server.tolerations | list | `[{"effect":"NoSchedule","key":"dedicated","operator":"Equal","value":"argocd"}]` | [Tolerations] for use with node taints |
